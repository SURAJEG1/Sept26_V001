...
public class BaseClass {
	...
	public void explicitWait() 
	{
		...
		WebElement dropdown = wait.until(ExpectedConditions.elementToBeClickable(By.id("")));
		dropdown.click();
	}
	...
	List <WebElement> dynamic = wait.until(ExpectedConditions.visibilityOfAllElementsLocatedBy(By.xpath("//input[@class=sasfsd'']")));
