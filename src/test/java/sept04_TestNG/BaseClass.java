...
public class BaseClass {
	...
	public void fluentWait() 
	{
		Wait<WebDriver> wait = new FluentWait<>(driver)
				...
				.ignoring(NoSuchDriverException.class);
		
		WebElement btnLogin=wait.until(ExpectedConditions.elementToBeClickable(By.id("")));
	}
	
	
	
	
	public void pageScrollDown(int left, int right) 
	{
