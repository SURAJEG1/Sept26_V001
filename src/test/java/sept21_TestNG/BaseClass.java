...
public class BaseClass {
	...
	public void explicitWait() 
	{
		...
		WebElement checkBox = wait.until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("")));
	}
	...
	public void fluentWait() 
	{
		...
		WebElement instaLink = wait.until(ExpectedConditions.elementToBeClickable(By.linkText("Instagram")));
	}
